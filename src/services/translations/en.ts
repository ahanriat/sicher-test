export default {
  ...
  "test-result-baseline": "Your test result is",
  "test-result-positive": "You should get tested",
  "test-result-negative": "You should not get tested",
  ...
  "we-dont-store-datas": "Don't worry we don't store any of your datas",
