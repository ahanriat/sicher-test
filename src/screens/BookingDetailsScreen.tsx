  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.subContainer}>
        ...
        >
          <Image source={require('../../assets/icons/icon-near-me.png')} style={{ height: 18, width: 18 }}/>
          <BaseText
        ...
        >
          <Image source={require('../../assets/icons/icon-calendar.png')} style={{ height: 18, width: 16 }}/>
          <BaseText
      ...
      <View style={{ alignItems: 'center', marginTop: 32 }}>
        <Image source={require('../../assets/icons/faq.png')} style={{ width: 29, height: 29 }}/>
        <BaseText
